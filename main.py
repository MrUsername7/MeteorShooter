...
wlan.active(True)
from Chatter import *
up_button, down_button, left_button, right_button, a_button, b_button, menu_button = Buttons.Key_2, Buttons.Key_8, Buttons.Key_4, Buttons.Key_6, Buttons.Enter, Buttons.Back, Buttons.Key_5
